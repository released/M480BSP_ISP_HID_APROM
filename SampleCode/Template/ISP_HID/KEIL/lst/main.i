...
uint8_t check_reset_source(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->RSTSTS |= 0x1FF;
    printf("\033[1;36m" "[LDROM]" "Reset Source <0x%08X>\r\n" "\033[0m",src);
   
    tag = rtc_read_magic_tag();
  

	if ((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(6))) + ((15)<<2)))) == (0UL))
	{
		rtc_write_magic_tag(0);
		printf("\033[1;36m" "[LDROM]" "Enter BOOTLOADER w/ Button pressed\r\n" "\033[0m");
		return (1UL);
	}

	
    if (src & (0x1ul << (0))) {
        SYS_ClearResetSrc((0x1ul << (0)));
        
        if (tag == 0xA5) {
            rtc_write_magic_tag(0);
            printf("\033[1;36m" "[LDROM]" "Enter BOOTLOADER from APPLICATION\r\n" "\033[0m");
            return (1UL);
        } else if (tag == 0xBB) {
            rtc_write_magic_tag(0);
            printf("\033[1;36m" "[LDROM]" "Upgrade finished...\r\n" "\033[0m");
            return (0UL);
        } else {
...
uint32_t caculate_crc32_checksum(uint32_t start, uint32_t size)
{
    ...
    CRC_Open((3UL << (30)), (((0x1ul << (24))) | ((0x1ul << (25))) | ((0x1ul << (27)))), 0xFFFFFFFF, (2UL << (28)));
    
    for(addr = start; addr < size; addr += 4){
        data = FMC_Read(addr);
        (((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->DAT = (data));
    }
...
uint8_t verify_application_chksum(void)
{
    ...
    chksum_cal = caculate_crc32_checksum(0x00000000, (g_apromSize - 4));
...
void BTN_Init(void)	
{
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH & ~((0xful << (28)))) | ((0x00UL<<(28)));
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL)),(0x00008000UL),0x0UL);
...
void DEBUG_UART_Init(void)
{
	...
	printf("\033[1;36m" "[LDROM]" "CLK_GetLXTFreq : %8d\r\n" "\033[0m",CLK_GetLXTFreq());	
	printf("\033[1;36m" "[LDROM]" "CLK_GetPCLK0Freq : %8d\r\n" "\033[0m",CLK_GetPCLK0Freq());
	printf("\033[1;36m" "[LDROM]" "CLK_GetPCLK1Freq : %8d\r\n" "\033[0m",CLK_GetPCLK1Freq());	
}
...
{
    TIMER_Open(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)), (1UL << (27)), 1);
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PWRCTL |= ((0x1ul << (2)) | (0x1ul << (0)));

     
    while (!(((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->STATUS & (0x1ul << (4))));

     
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL = ((0x00080000UL | (((2UL)-1UL)<<9) | (((32UL)-2UL)) | 0x4000UL));

    while (!(((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->STATUS & (0x1ul << (2))));

    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 &= ~(0xful << (0));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 |= ((((1)) - 1UL) << (0));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 &= ~(0xful << (4));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 |= ((((4)) - 1UL) << (4));
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL0 & (~(0x7ul << (0)))) | (0x2UL << (0));

     
     
    
    PllClock        = (192000000);                        
    SystemCoreClock = (192000000) / (1);             
    CyclesPerUs     = SystemCoreClock / 1000000;  

     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY & ~(0x3ul << (0))) | (0x1ul << (8)) | (0x1ul << (2));

     
    CLK_EnableModuleClock(((1UL<<30)|(0x0UL<<28)|(1UL<<25) |(8UL<<20) |(0x0UL<<18)|(0xFUL<<10) |(4UL<<5) |(27UL<<0)));
    CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(2UL<<0)));

    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->AHBCLK |= (0x1ul << (2));

    CLK_EnableModuleClock(((1UL<<30)|(1UL<<28) |(0x3UL<<25) |(24UL<<20) |(0UL<<18) |(0xFUL<<10) |(8UL<<5) |(16UL<<0)));
    CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x3UL<<25) |(24UL<<20) |(0UL<<18) |(0xFUL<<10) |(8UL<<5) |(16UL<<0)), (0x3UL << (24)), (((1) - 1UL) << (8)));
    ...
    CLK_EnableModuleClock(((1UL<<30)|(3UL<<28) |(0x1UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(1UL<<0)));
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x1UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(1UL<<0)), (0x1UL << (8)),  0);

    CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(7UL<<0)));
    ...
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL))->MODE &= ~((0x3ul << (24)) | (0x3ul << (26)) | (0x3ul << (28)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH &= ~((0xful << (16)) | (0xful << (20)) | (0xful << (24)) | (0xful << (28)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH |= ((0x0EUL<<(16)) | (0x0EUL<<(20)) | (0x0EUL<<(24)) | (0x0EUL<<(28)));
...
int main(void)
{
    ...
    FMC_Open();
    (((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPCTL |= (0x1ul << (3)));
    
    
    
    
    g_apromSize = 0x00076000UL;
    ...
    if (!check_reset_source()) 
	{
		...
		{
            printf("\033[1;36m" "[LDROM]" "Stay in BOOTLOADER\r\n" "\033[0m");
        }
    } 
	else 
    {
    ...
    while (1)
    {
        ...
        if (timeout_cnt > (5)) {
            printf("\033[1;36m" "[LDROM]" "Time-out, perform CHIP_RST\r\n" "\033[0m");
            while(!((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))))->FIFOSTS & (0x1ul << (28))) >> (28)));
...
_APROM:
    printf("\033[1;36m" "[LDROM]" "Jump to <APPLICATION>\r\n" "\033[0m");
    while(!((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))))->FIFOSTS & (0x1ul << (28))) >> (28)));
