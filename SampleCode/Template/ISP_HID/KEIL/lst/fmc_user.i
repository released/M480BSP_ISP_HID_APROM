...
int FMC_Proc(unsigned int u32Cmd, unsigned int addr_start, unsigned int addr_end, unsigned int *data)
{
    ...
    {
        ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPCMD = u32Cmd;
        ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPADDR = u32Addr;

        if (u32Cmd == 0x21UL)
        {
            ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPDAT = *data;
        }

        ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPTRG = 0x1;
        do { __schedule_barrier(); __isb(0xF); __schedule_barrier(); } while (0U);

        while (((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPTRG & 0x1) ;   

        Reg = ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPCTL;

        if (Reg & (0x1ul << (6)))
        {
            ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPCTL = Reg;
            return -1;
        }

        if (u32Cmd == 0x00UL)
        {
            *data = ((FMC_T *) (((uint32_t)0x40000000) + 0x0C000UL))->ISPDAT;
        }
...
int FMC_Write_User(unsigned int u32Addr, unsigned int u32Data)
{
    return FMC_Proc(0x21UL, u32Addr, u32Addr + 4, &u32Data);
}
...
int FMC_Read_User(unsigned int u32Addr, unsigned int *data)
{
    return FMC_Proc(0x00UL, u32Addr, u32Addr + 4, data);
}
...
int FMC_Erase_User(unsigned int u32Addr)
{
    return FMC_Proc(0x22UL, u32Addr, u32Addr + 4, 0);
}

void ReadData(unsigned int addr_start, unsigned int addr_end, unsigned int *data)    
{
    FMC_Proc(0x00UL, addr_start, addr_end, data);
    return;
}

void WriteData(unsigned int addr_start, unsigned int addr_end, unsigned int *data)  
{
    FMC_Proc(0x21UL, addr_start, addr_end, data);
    return;
}
...
int EraseAP(unsigned int addr_start, unsigned int size)
{
    ...
    while (size > 0)
    {
        if ((size >= (0x00080000UL/2UL)) && !(u32Addr & ((0x00080000UL/2UL) - 1)))
        {
            u32Cmd = 0x23UL;
            u32Size = (0x00080000UL/2UL);
        }
        else if ((size >= (0x1000UL * 4UL)) && !(u32Addr & ((0x1000UL * 4UL) - 1)))
        {
            u32Cmd = 0x25UL;
            u32Size = (0x1000UL * 4UL);
        }
        else
        {
            u32Cmd = 0x22UL;
...
void UpdateConfig(unsigned int *data, unsigned int *res)
{
    ...
    FMC_Proc(0x22UL, 0x00300000UL, 0x00300000UL + 8, 0);
    FMC_Proc(0x21UL, 0x00300000UL, 0x00300000UL + u32Size, data);

    if (res)
    {
        FMC_Proc(0x00UL, 0x00300000UL, 0x00300000UL + u32Size, res);
    }
