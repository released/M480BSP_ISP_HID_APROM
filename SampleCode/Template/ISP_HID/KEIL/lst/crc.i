...
#line 10 "..\\..\\..\\..\\Library\\StdDriver\\src\\crc.c"
...
void CRC_Open(uint32_t u32Mode, uint32_t u32Attribute, uint32_t u32Seed, uint32_t u32DataLen)
{
    ((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->SEED = u32Seed;
    ((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->CTL = u32Mode | u32Attribute | u32DataLen | (0x1ul << (0));

     
    ((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->CTL |= (0x1ul << (1));
}
...
uint32_t CRC_GetChecksum(void)
{
    ...
    switch(((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->CTL & (0x3ul << (30)))
    {
    case (0UL << (30)):
    case (2UL << (30)):
        ret = (((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->CHECKSUM & 0xFFFFU);
        break;
    case (3UL << (30)):
        ret = (((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->CHECKSUM);
        break;
    case (1UL << (30)):
        ret = (((CRC_T *) (((uint32_t)0x40000000) + 0x31000UL))->CHECKSUM & 0xFFU);
        break;
    default:
        ret = 0U;
        break;
